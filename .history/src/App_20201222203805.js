    ...
    <div className="App">
      ...
      <div class="mainContainer">
        ...
        <div class="productData">
          ...
          <div>
            <img class="ProductImage SelectedProductImage" src="https://imgur.com/iOeUBV7.png" alt="band color"/>
            <img class="ProductImage " src="https://imgur.com/PTgQlim.png" alt="band color"/>
            <img class="ProductImage " src="https://imgur.com/Mplj1YR.png" alt="band color"/>
            <img class="ProductImage " src="https://imgur.com/xSIK4M8.png" alt="band color"/>
          </div>
        </div>
      </div>
    </div>
